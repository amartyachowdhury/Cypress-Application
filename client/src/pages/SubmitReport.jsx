...
function SubmitReport() {
  ...
  const steps = [
    ...
    },
    {
      number: 2,
      title: 'Details',
      description: 'Category and severity',
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-blue-50 to-indigo-100 relative overflow-hidden">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-12 shadow-2xl text-center max-w-md mx-4 relative z-10 transform animate-in zoom-in-95 duration-500">
          ...
          <p className="text-gray-600 text-lg mb-8 leading-relaxed">
            ...
            successfully submitted and is now being reviewed.
          </p>
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
            Help make our community better by reporting issues that need
            attention. Your contribution makes a real difference!
          </p>
        </div>
            ...
            <div className="flex items-center justify-between mb-8">
              {steps.map((step, index) => (
                <div key={step.number} className="flex items-center">
                  <div
                    className={`flex items-center justify-center w-14 h-14 rounded-2xl border-2 font-bold text-lg transition-all duration-500 ${
        ...
        <form
          ...
          className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-8 md:p-12 relative overflow-hidden"
        >
          {/* Background decoration */}
                  ...
                  {loading ? (
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <span className="text-blue-700 text-lg">
                        Failed to get your location. Please enter an address
                        above.
                      </span>
                    </div>
                  )}
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 text-base mb-6 leading-relaxed">
                    Upload up to 5 images to help illustrate the issue. Clear
                    photos can help authorities better understand and address
                    the problem quickly.
                  </p>
