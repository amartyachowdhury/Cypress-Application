                        ...
                        <nav className="hidden md:flex items-center space-x-8">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <button
                                    ...
                                    className="relative px-4 py-2 text-red-600 hover:text-white rounded-xl transition-all duration-300 font-medium overflow-hidden group"
                                >
                        ...
                        <div className="md:hidden py-4 border-t border-gray-200/50 animate-in slide-in-from-top-2 duration-300">
                            <nav className="flex flex-col space-y-4">
                                ...
                                <div className="px-4 py-3 border-t border-gray-200/50 pt-4">
                                    ...
                                    <button
                                        onClick={handleLogout}
                                        className="w-full text-left px-4 py-3 text-red-600 hover:text-white hover:bg-red-600 rounded-xl transition-all duration-300 font-medium transform hover:scale-105"
                                    >
                                        Logout
                                    </button>
                                </div>
