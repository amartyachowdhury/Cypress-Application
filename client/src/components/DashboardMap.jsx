...
const QuickActionCard = ({
  ...
  const colorClasses = {
    ...
    green:
      'bg-gradient-to-br from-green-50 to-green-100 border-green-200 hover:from-green-100 hover:to-green-200 text-green-700 shadow-green-100',
    purple:
      'bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 hover:from-purple-100 hover:to-purple-200 text-purple-700 shadow-purple-100',
    orange:
      'bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200 hover:from-orange-100 hover:to-orange-200 text-orange-700 shadow-orange-100',
  };
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
      <div className="flex items-center justify-between">
        ...
        <div
          className={`text-4xl p-3 rounded-xl bg-gradient-to-br ${gradient} text-white shadow-lg`}
        >
          {icon}
        </div>
      </div>
...
const DashboardMap = () => {
  ...
  const filteredReports = reports.filter(report => {
    const statusMatch =
      filteredStatus === 'all' || report.status === filteredStatus;
    const categoryMatch =
      filteredCategory === 'all' || report.category === filteredCategory;
    const severityMatch =
      filteredSeverity === 'all' || report.severity === filteredSeverity;
  ...
  const getStatusBadge = status => {
    ...
    return (
      <span
        className={`px-3 py-1 rounded-full text-xs font-semibold border ${colors[status] || colors.open}`}
      >
        {status}
      </span>
    );
  ...
  const getSeverityBadge = severity => {
    ...
    return (
      <span
        className={`px-3 py-1 rounded-full text-xs font-semibold border ${colors[severity] || colors.low}`}
      >
        {severity}
      </span>
    );
      ...
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">
            Loading your community reports...
          </p>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-8">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            Stay connected with your community. View reports, submit new issues,
            and track progress on local improvements that make our neighborhood
            better for everyone.
          </p>
        </div>
      ...
      {showMap ? (
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20">
          <div className="p-6 border-b border-gray-200/50">
            ...
            <p className="text-gray-600">
              Browse through all community reports
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                Thank you for using Cypress Community Hub! Here are some
                guidelines to help make our community better:
              </p>
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <span className="text-blue-500 text-lg">•</span>
                  <span className="text-gray-700">
                    Be specific and detailed when describing issues
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-blue-500 text-lg">•</span>
            ...
            <div className="space-y-4">
              <ul className="space-y-3">
                ...
                <li className="flex items-start space-x-3">
                  <span className="text-blue-500 text-lg">•</span>
                  <span className="text-gray-700">
                    Follow up on the status of your reports
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-blue-500 text-lg">•</span>
              ...
              <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-white/50">
                <p className="text-sm text-gray-600 text-center font-medium">
                  Together, we can make our community a better place for
                  everyone!
                </p>
              </div>
            </div>
